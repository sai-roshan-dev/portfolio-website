...
const WORDS = ["AI Explorer", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js","Python","MongoDB","Express.js","Bootstrap","GenAI","MCP"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/sai-roshan-dev/" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/sai-roshan963/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
Creating AI-powered, innovative, and user-friendly web applications that solve real-world problems.
                </p>
